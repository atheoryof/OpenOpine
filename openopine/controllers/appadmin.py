...
def index():
    return dict(searchrevs=[], searchprofs=[], tag_form='', databases=databases)
...
def insert():
    ...
    return dict(searchrevs=[], searchprofs=[],tag_form='',form=form,table=db[table])
...
#         regex = re.compile(request.args[0] + '\.(?P<table>\w+)\.id\>0')
    ...
    return dict(
        ...
        searchrevs=[], searchprofs=[],tag_form='')
